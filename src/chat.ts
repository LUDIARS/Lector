...
//
// もとは Memoria server/parsers/chat.ts (extension/content.js の
// extractChatGpt / extractClaude / extractGemini をサーバ側で再現したもの)。
// 共有パッケージとして切り出した。 保存済 HTML (= レンダリング後だが JS は
// 走らない静的 HTML) を node-html-parser で解析する。

import { parse as parseHtml, type HTMLElement } from 'node-html-parser';
import type { ChatExtractionSource, ChatExtractedMessage } from './types.js';
